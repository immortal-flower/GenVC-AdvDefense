#!/bin/bash
# I2V AR Compression — 1080p full UVG (all frames, same as DCVC-RT benchmark)
...
echo "============================================================"
echo " I2V AR 1080p — Full UVG benchmark (all frames per sequence)"
echo " Started: $(date)"
echo "============================================================"
...
echo "============================================================"
echo " I2V AR 1080p finished: $(date)"
echo "============================================================"
